...
"""Pre-process some scrapped Mozilla Firefox bug reports

Clean the fields of the scrapped Mozilla Firefox bug reports.
"""
...
if __name__ == "__main__":
    """Main program"""
    input_data_file = "../scrap_mozilla_firefox/brs.json" # Path of
