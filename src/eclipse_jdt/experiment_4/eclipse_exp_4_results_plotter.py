...
class EclipseExp4ResultsPlotter(Exp4ResultsPlotter):
...
def main():
    ...
    eclipse_exp_4_results_plotter = \
    EclipseExp4ResultsPlotter(cleaned_results_file_name)
    eclipse_exp_4_results_plotter.plot_results()
