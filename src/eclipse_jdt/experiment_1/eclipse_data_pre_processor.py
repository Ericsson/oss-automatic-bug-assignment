...
class EclipseDataPreProcessor(DataPreProcessor):
...
def main():
    ...
    eclipse_data_pre_processor = EclipseDataPreProcessor(data_file, \
    ...
    # Pre-processer
    eclipse_data_pre_processor.clean_data() # We clean the data
    eclipse_data_pre_processor.write_data(output_data_file) # We write the
