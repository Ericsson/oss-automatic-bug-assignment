# -*- coding: utf-8 -*-
"""
.. module:: mozilla_size_of_data_set_incremental_experiment
   ...
   :synopsis: This module contains a class used to conduct the first 
              ...
              classifier. In the context of the first sub experiment, 
              all the folds, except the oldest one, are used to 
